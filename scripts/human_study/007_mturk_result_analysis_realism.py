...
if __name__ == '__main__':
    ...
    df = pd.read_csv(PROJECT_DIR.joinpath('scripts', 'human_study', 'data', 'realism_mturk_data.csv'), index_col=0)
    df['image'] = df['Input.image']
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig("007_realism_mturk.pdf")
