...
class SDImage2Image:
    ...
    def __init__(self, prompt: str, guidance: float, num_inference_step: int = 30, strength: float = 0.3):
    ...
    def forward(self, x):
        ...
        return resize_original(self.pipe(prompt=self.prompt, image=x, strength=self.strength, height=h * 2,
...
if __name__ == '__main__':
    ...
    model = SDImage2Image("a street in the usa, photo taken from a car", 7.5, strength=0.3)
    ...
    for i in range(n_runs):
        ...
        torchvision.utils.save_image(result, f"sd_image2image_{i}.jpg")
