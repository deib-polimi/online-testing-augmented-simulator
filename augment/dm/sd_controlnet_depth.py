...
class SDControlnet:
    ...
    def __init__(self, prompt: str, guidance: float, num_inference_step: int = 30):
        self.pipe = StableDiffusionControlNetPipeline.from_pretrained(
            ...
            controlnet=ControlNetModel.from_pretrained("lllyasviel/sd-controlnet-depth", torch_dtype=torch.bfloat16))
        ...
        self.hint_generator = MidasDetector.from_pretrained("lllyasviel/Annotators")
