...
class SDControlnet:
    ...
    def __init__(self, prompt: str, guidance: float, num_inference_step: int = 30):
        self.pipe = StableDiffusionControlNetPipeline.from_pretrained(
            ...
            controlnet=ControlNetModel.from_pretrained("lllyasviel/sd-controlnet-hed", torch_dtype=torch.bfloat16))
        ...
        self.hint_generator = HEDdetector.from_pretrained("lllyasviel/Annotators")
...
if __name__ == '__main__':
    ...
    sd_controlnet = SDControlnet("a street in the usa, photo taken from a car", 7.5)
