...
if __name__ == '__main__':
    ...
    model = StableDiffusionInpainting(prompt="", guidance=10, num_inference_step=25, input_shape=(3, 360, 480))
    prompts = [
    ...
    for prompt in prompts:
        ...
        for run_folder in [
            ...
            out = output_folder.joinpath(run_folder.name, "inpainting", prompt)
