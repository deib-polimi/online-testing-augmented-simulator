...
TIME_PROMPTS_MAP = {x: f"A street during {x}, photo taken from a car" for x in TIMES}
...
PROMPT_TO_DOMAIN_MAP = {
    **{f"A street in {x} weather, photo taken from a car": x for x in WEATHERS},
    **{f"A street in {x} season, photo taken from a car": x  for x in SEASONS},
    **{f"A street in {x}, photo taken from a car": x for x in COUNTRIES},
    **{f"A street in {x}, photo taken from a car": x  for x in CITIES},
    **{f"A street in {x}, photo taken from a car": x  for x in LOCATIONS},
    **{f"A street during {x}, photo taken from a car": x  for x in TIMES},
}
